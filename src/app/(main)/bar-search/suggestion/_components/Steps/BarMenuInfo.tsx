  ...
  return (
    <>
      ...
      {fields.length > 0 ? (
              ...
              <Fragment key={field.id}>
                ...
                <FormItem label="설명" required>
                  <Textarea
                    ...
                    aria-invalid={
                      !!errors.signatureCocktails?.[index]?.description
                    }
                  />
                  <FormErrorMessage
        ...
        <section className="my-20 flex flex-col items-center gap-2">
          <SubTitleText
            title="시그니처 칵테일이 없는 바인가요?"
            className="w-full justify-center text-center"
          />
          <p className="text-gray-400">
            <span>
              시그니처 칵테일이 있다면{' '}
              <span className="font-semibold">메뉴 입력 추가</span> 버튼을
              클릭해 주세요
            </span>
          </p>
          <Button
