...
import { BusinessHourDetailSchemes } from './business-hour.types'
...
export const BarSchemes = z.object({
  ...
  category: z.array(z.string()), // 바 카테고리
  ...
  signature_menus: z.array(
    SignatureMenuSchemes.omit({
      description: true,
      image: true,
      abv: true,
      ingredients: true,
  ...
  business_hours: z.array(
    BusinessHourDetailSchemes.omit({
      barId: true,
    }),
  ), // 바 영업시간
})
