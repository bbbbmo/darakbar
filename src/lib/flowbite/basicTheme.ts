  ...
  select: {
    field: {
      select: {
        colors: {
          primary:
            'border-gray-800 bg-gray-700 text-gray-50 focus:border-gray-900 focus:ring-gray-800',
        },
      },
    },
  },
  ...
  tabs: {
    ...
    tablist: {
      ...
      variant: {
        ...
        underline:
          '-mb-px flex-wrap border-b border-gray-200 dark:border-gray-700 bg-neutral-600',
        pills:
          'flex-wrap space-x-2 text-sm font-medium text-gray-500 dark:text-gray-400 bg-neutral-600',
        fullWidth:
          'grid w-full grid-flow-col divide-x divide-gray-200 rounded-none text-sm font-medium shadow dark:divide-gray-700 dark:text-gray-400 bg-neutral-600',
      },
      tabitem: {
